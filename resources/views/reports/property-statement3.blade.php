            ...
            <div class="col-md-12">
                ...
                <div class="col-md-12 col-md-offset-1">
                    <div class="form-group" id="date-range-div" >
                        <form action="{{ url('getrentPayment') }}" id="plot-form" method="post">
                            {{ csrf_field() }}
                            <div class="col-md-3">
                ...
                <table class="table table-striped">
                    ...
                    @if(count($pay))
                        ...
                        @foreach($pay as $pays)
                            ...
                            @endphp
                            <tr>
                                <td>{{$pays['full_name']}}</td>
                                <td>{{$pays['date']}}</td>
                                <td>{{$pays['ref_number']}}</td>
                                <td>{{$pays['name']}}</td>
                                <td>{{ $pays['unit_number'] }}</td>
                                <td>{{ number_format($pays['amount'],2) }}</td>
                                {{--{{ number_format($statement['monthly_rent'],2) }}--}}
                                <td></td>
                        ...
                        <tr>
                            ...
                            <th style="text-align: right;"><h3 class="no-top">{{ number_format($total,2) }}</h3></th>
